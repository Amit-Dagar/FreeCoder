...
<head>
    ...
    <title> <?php echo $name;?> - Freecoder</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        ...
                        {
                        $id=$_SESSION['user'];
                        $sql1="select * from articles where user_id=$id";
                        $sql2="select * from articles where user_id=$id AND article_status=2";
                        $sql3="select * from articles where user_id=$id AND article_status=1";
                        ...
                        <div class="card">
                            ...
                            <div class="card-block little-profile text-center">
                                ...
                                <a href="profile.php" class="m-t-10 waves-effect waves-dark btn btn-primary btn-md btn-rounded">Profile</a><span>
                                ...
                                <div class="row text-center m-t-20">
                                    <div class="col-lg-4 col-md-4 m-t-20">
                                        <h3 class="m-b-0 font-light"><?php echo $all;?></h3><small>Total Codes</small></div>
                                    <div class="col-lg-4 col-md-4 m-t-20">
                                        <h3 class="m-b-0 font-light"><?php echo $accepted;?></h3><small>Accepted</small></div>
                                    <div class="col-lg-4 col-md-4 m-t-20">
                                    ...
                                    <table class="table">
										...
										?>
                                            <tr>
                                                ...
                                                <td style="font-size:13px;"><?php echo substr($row['title'],0,50);?></td>
                                                <td style="font-size:12px;"><?php echo date("j M, Y", strtotime($row['post_date']));?></td>
                                                <?php
												if($row['article_status']==1)
												{
													echo '<td class="text-success" style="font-size:12px;">Accepted</td>';
												}
												else if($row['article_status']==2)
												{
												echo '<td class="text-warning" style="font-size:12px;">Pending</td>';
												}	
                                                else{
                                                echo '<td class="text-danger" style="font-size:12px;">Rejected</td>';
                                                }                                                											
												?>
                                            </tr>
										<?php
