...
<head>
    ...
    <title>Settings - Freecoder</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                                ...
                                <div class="card-block">
                                  <div class="panel panel-default">
                                      ...
                                      <div class="panel-body">
                                        <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" id="deactivate">
                                        <strong>Deactivate Your Accunt?</strong><br><br>
                                        <input type="hidden" name="token">
                                        <b class="btn btn-danger" onclick="deactivate()">Deactivate Account</b>
                                        </form>
                                      </div>
                                  </div>
                                </div>
                    ...
                    <script>
                    function deactivate() {
                        var r = confirm("Do you really want to deactivate your account!");
                        if (r == true) {
                            $('#deactivate').submit();
                        } else {
