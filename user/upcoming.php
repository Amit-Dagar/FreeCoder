            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">Features</h3>
                        <ol class="breadcrumb">
                        ...
                        <div class="card">
							...
							<div id="main" class="text-center center-block container jumbotron">
								<div id="detail" class="span12">
									<h1><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Page Under Construction <i class="fa fa-exclamation-triangle" aria-hidden="true"></i></h1>
