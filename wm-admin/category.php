...
<head>
        ...
        <title>Category - FreeCoder</title>
                        											...
                        											if($result->num_rows>0)
                        											{
                        												...
                        												{ echo'
                        													<tr>
                        														<td>'.$row['id'].'</td>
                        														<td>'.$row['name'].'</td>
                        														<td class="text-center"><a href="edit.php?cat_id='.$row['id'].'"><i class="fa fa-pencil"></i></a></td>
                        														<td class="text-center"><a href="delete.php?cat_id='.$row['id'].'"><i class="fa fa-trash"></i></a></td>
                        													</tr>';
                        												}
                        											}
                        											?>
